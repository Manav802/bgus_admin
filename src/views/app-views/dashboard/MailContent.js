	...
	render() {
		...
		return (
			<Switch>
				...
				<Route path={`${match.url}/service_quotes/:id`} component={(props)=><ContactEnquiryDetail category="contact_enquiries" {...props}/>} />
				<Route path={`${match.url}/service_quotes/:id`} component={(props)=><ReportErrorDetail category="report_errors" {...props}/>} />
				<Route path={`${match.url}/service_quotes/:id`} component={(props)=><UserFeedbackDetail category="user_feedbacks" {...props}/>} />
				...
				<Route exact path={`${match.url}/user_feedbacks`} component={(props)=><UserFeedback category="user_feedbacks" {...props}/>} />
